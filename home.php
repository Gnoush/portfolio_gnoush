...
<nav>
    ...
    <div class="nav-elements">
        ...
        <a href="<?php echo get_bloginfo('stylesheet_directory'); ?>/CV-agnes-guinin.pdf"
           download="cv_agnes_guinin">cv</a>
        <div class="network">
...
<section class="home">
    ...
    <div class="main-part">
        <a class="cv-container" href="<?php echo get_bloginfo('stylesheet_directory'); ?>/CV-agnes-guinin.pdf"
           download="cv_agnes_guinin">
            <div class="cv-img">
        ...
        <div class="name-margin">
            ...
            <img class="logo-responsive"
                 src="<?php echo get_bloginfo('stylesheet_directory'); ?>/img/logo-ag-white.svg">
        </div>
...
<section class="about-me" id="aboutme">
    ...
    <div class="about-me-img-responsive-image-wrapper">
        <img class="about-me-img-responsive"
             src="<?php echo get_bloginfo('stylesheet_directory'); ?>/img/aboutme-responsive.png" alt="">
    </div>
    <div class="about-me-description">
        <h2><span>à</span> propos</h2>
        <p>
            Étudiante en webdesign à Sup'Internet sur Paris, amoureuse d'illustrations et un peu geek sur les bords, je
            passe beaucoup de temps entre mes livres et ma passion, le webdesign.
            <br><br>Après un bac littéraire en 2014, j'ai d'abord suivi deux ans de classe préparatoire littéraire en me
            spécialisant en littérature et langue anglaise, avant de m'inscrire à Sup'Internet par volonté de sortir de
            l'aspect théorique et de rentrer dans un apprentissage plus pratique et concret. J'y ai découvert le
            webdesign, avec tous les aspects de créativité, de réflexion et de partage qui le compose.
            <br><br>J'aime réaliser des interfaces claires, pratiques et accueillantes pour l'utilisateur, et répondre
            au mieux au besoin de mes clients.
...
<section id="contact">
    <h2>Contact</h2>
    <form method="post">
        Nom : <input type="text" name="name" value="<?php if (array_key_exists("name", $_POST)) {
            echo esc_attr($_POST["name"]);
        } else {
            echo null;
        } ?>">
        Status : <input list="statues" name="status" value="<?php if (array_key_exists("status", $_POST)) {
            echo esc_attr($_POST["status"]);
        } else {
            echo null;
        } ?>">
        <datalist id="statues">
        ...
        Nom Entreprise : <input type="text" name="companyName"
                                value="<?php if (array_key_exists("companyName", $_POST)) {
                                    echo esc_attr($_POST["companyName"]);
                                } else {
                                    echo null;
                                } ?>">
        Email : <input type="email" name="email" value="<?php if (array_key_exists("email", $_POST)) {
            echo esc_attr($_POST["email"]);
        } else {
            echo null;
        } ?>">
        Téléphone : <input type="tel" name="phone" value="<?php if (array_key_exists("phone", $_POST)) {
