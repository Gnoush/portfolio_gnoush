...
<?php include_once "header.php"; ?>
    ...
    <section class="project-wrapper project-name project-name-illu">
        ...
        <img src="<?php echo get_bloginfo('stylesheet_directory'); ?>/img/illu-3-portfolio.png" alt="">
        <img src="<?php echo get_bloginfo('stylesheet_directory'); ?>/img/illu-1-portfolio.png" alt="">
        <img src="<?php echo get_bloginfo('stylesheet_directory'); ?>/img/illu-cv.png" alt="">
    </section>
